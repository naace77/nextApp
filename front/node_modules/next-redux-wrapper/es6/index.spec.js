...
var makeStore = function (initialState) { return createStore(reducer, initialState, applyMiddleware(promiseMiddleware)); };
...
var NoStorePage = /** @class */ (function (_super) {
    __extends(NoStorePage, _super);
    function NoStorePage() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NoStorePage.getInitialProps = function (_a) {
        var ctx = _a.ctx;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, { custom: 'custom' }];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    component = renderer.create(React.createElement(WrappedPage, __assign({}, props)));
...
describe('store integration', function () {
    test('simple', function () { return __awaiter(_this, void 0, void 0, function () {
        var WrappedPage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    WrappedPage = withRedux(makeStore)(SyncPage);
    ...
    test('async', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    WrappedPage = withRedux(makeStore)(AsyncPage);
                    return [4 /*yield*/, verifyComponent(WrappedPage)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
describe('client integration', function () {
    test('store taken from window', function () { return __awaiter(_this, void 0, void 0, function () {
        var WrappedPage, store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    global['window'] = {}; // nasty hackery
                    WrappedPage = withRedux(makeStore, { storeKey: 'testStoreKey' })(NoStorePage);
                    store = makeStore({});
                    global['window']['testStoreKey'] = store;
                    return [4 /*yield*/, store.dispatch({ type: 'FOO', payload: 'foo' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, verifyComponent(WrappedPage)];
                case 2:
    ...
    test('store not taken from window', function () { return __awaiter(_this, void 0, void 0, function () {
        var WrappedPage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    global['window'] = {}; // nasty hackery
                    WrappedPage = withRedux(makeStore, { storeKey: 'testStoreKey' })(SyncPage);
                    return [4 /*yield*/, verifyComponent(WrappedPage)];
                case 1:
                    _a.sent();
                    delete global['window'];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    WrappedPage = withRedux(makeStore, {
