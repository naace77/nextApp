...
var edoc01 = function edoc01() {
  ...
  console.log(_globalValue__WEBPACK_IMPORTED_MODULE_6__["LIST_EDEG1CODE"]);
  ...
  var filtedEdeg1code = _globalValue__WEBPACK_IMPORTED_MODULE_6__["LIST_EDEG1CODE"].map(function (item, index) {
    if (item.value === 100 || item.value === 200) return {
      text: item.name,
      value: item.value
    };
  });
  console.log(filtedEdeg1code);
  var columns = [{
    title: "구분",
    dataIndex: "EDEG2Code",
    key: "EDEG2Code",
    width: "10%",
    filters: filtedEdeg1code,
...
//# sourceMappingURL=edocument.js.25047188a344384d9c6d.hot-update.js.map